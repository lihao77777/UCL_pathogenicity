...
if (length(args) < 1) {
  args = c(
    ...
    "--write_table", "SMAD6_filtered_table",
...
table_generator = function(saofile){
...
}else if (filtered_table != "" & w_script_pymol != "" & w_script_pp != ""){
  ratio = chi_ratio
